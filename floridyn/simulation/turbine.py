...
class Turbine(LoggerBase):
    ...
    def __init__(self, instance_dictionary):
        ...
        self.ai_set = properties["ai_set"]
        self.ai_control = properties["ai_control"]
        self.eta = 0.77
    ...
    def _fCp(self, at_wind_speed):
        ...
        # TODO: convert this to blade pitch angle and tip speed ratio
        if self.ai_control:
            _cp = self.eta * 4 * self.ai_set * (1 - self.ai_set)  ** 2
            return float(_cp)
    ...
    def _fCt(self, at_wind_speed):
        ...
        # TODO: convert this to blade pitch angle and tip speed ratio
        if self.ai_control:
            _ct = 4 * self.ai_set * (1 - self.ai_set)
            return float(_ct)
