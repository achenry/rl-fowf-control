...
class Floris(BaseClass):
    ...
    def __init__(self, input_file=None, input_dict=None):
        ...
        # dict_keys: turbine, wake, farm, type, name, description, floris_version, logging
        # as_dict, check self.farm.turbine, self.farm.wake, self.meta_dict
