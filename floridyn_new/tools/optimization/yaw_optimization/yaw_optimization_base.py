...
class YawOptimization:
    ...
    def __init__(
        ...
        if yaw_angles_baseline is not None:
            ...
            b = [t.yaw_angle for t in self.fi.floris.farm.turbines] # self.fi.floris.farm.yaw_angles
    ...
    def _unpack_variable(self, variable, subset=False):
        ...
        if len(np.shape(variable)) == 1:
            ...
            variable = np.tile(
                variable,
                (
                    1, # self.fi.floris.flow_field.n_wind_directions,
                    1, # self.fi.floris.flow_field.n_wind_speeds,
                    1
                )
            )
